...
htpasswd -cb /usr/local/etc/.htpasswd R_Eason P@ssw0rd1!                                         # Create .htaccess with user R_Eason and in-class password.
htpasswd -b /usr/local/etc/.htpasswd R_Eason2 P@ssw0rd1!                                         # Create user R_Eason2 with in-class password
...
echo "require user R_Eason" >> /var/www/html/pages.dir/.htaccess                                 # Concatenate to .htaccess
echo "require user R_Eason2" >> /var/www/html/pages.dir/.htaccess                                # Concatenate to .htaccess
