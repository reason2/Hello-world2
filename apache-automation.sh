...
htpasswd -cb /usr/local/etc/.htpasswd REason P@ssw0rd1!                                           # Create .htaccess with user Hack and standard password.
htpasswd -b /usr/local/etc/.htpasswd REason2 P@ssw0rd1!                                           # Create user Hack1 with standard password
